...
def test_promo_wrong_length():
    acc = PersonalAccount("Jan", "Kowalski", "80010112345", "PROM_12345")
    assert acc.balance == 0

def test_born_after_2000():
    acc = PersonalAccount("Jan", "Kowalski", "02210112345", "PROM_XYZ")